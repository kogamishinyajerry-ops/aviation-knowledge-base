...
<h2>下一步（Phase 7+）</h2>
<p>把 <a href="https://github.com/kogamishinyajerry-ops/aviation-knowledge-base/blob/main/.planning/design/RAG_PIPELINE.md">RAG_PIPELINE.md</a> 设计文档变成真服务：</p>
<ul>
  <li>实现 <code>scripts/exporters/to_ragflow.py</code>（目前是 NotImplementedError 骨架）</li>
  <li>启动 <code>deploy/docker-compose.yml.draft</code>（目前标记 DRAFT）</li>
  <li>把 3 个 demo 文档摄取进 RAGFlow，跑 30 个 eval 查询</li>
</ul>
"""
